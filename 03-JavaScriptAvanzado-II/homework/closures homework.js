...
// var funcionHija = counter();
// var funcionHija = counter();
// console.log("A ver>", funcionHija());
// console.log("A ver>", funcionHija());
// console.log("A ver>", funcionHija());
// console.log("A ver>", funcionHija());
...
function cacheFunction(cb) {
  ...
  return function (arg) {
    if (cache.hasOwnProperty(arg)) {
      // SI existe en la hoja/cache
      console.log("ESTOY EN EL CACHE");
      return cache[arg];
    } else {
      // cache.apellido = "algo" // toma .apellido literalmente con esos caracteres
      // cache.arg = cb(arg) // cache.arg ESTA MAL XXXXX -> {arg = "algo"}
      var resultado = cb(arg);
      cache[arg] = resultado; // ESTA BIEN! {5: 25}
      console.log("agregando propiedad...", cache);
      return cache[arg]; // 25
    }
  };
}
...
var funcionHija = cacheFunction(cb);

// console.log(funcionHija(3));
// console.log(funcionHija(5));
// console.log(funcionHija(5));
//----------------------------------------
...
let getNombreBest = getNombre.bind(best);
// console.log(getNombreBest());
...
let textoAsteriscos = crearCadena.bind(null, "*", "*"); // "Messi" -> "*Messi*"
